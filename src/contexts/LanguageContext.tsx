...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "projectInfo.projectNamePlaceholder": "Enter project name",
    "projectInfo.promoter": "Promoter Name",
    "projectInfo.promoterPlaceholder": "Enter promoter name",
    "projectInfo.location": "Location",
    "projectInfo.locationPlaceholder": "Enter location",
    "projectInfo.sector": "Industry Sector",
    "projectInfo.sectorPlaceholder": "Enter sector",
    ...
    "personnel.role": "Role",
    "personnel.rolePlaceholder": "Enter role",
    ...
    "activities.activityPlaceholder": "Enter activity name",
    ...
    "customers.segmentNamePlaceholder": "Enter segment name",
    ...
    "otherCharges.chargePlaceholder": "Enter charge name",
    "otherCharges.rawMaterials": "Raw Materials",
    "otherCharges.addMaterial": "Add Material",
    "otherCharges.materialPlaceholder": "Enter material name",
  ...
  fr: {
    ...
    "projectInfo.projectNamePlaceholder": "Entrez le nom du projet",
    "projectInfo.promoter": "Nom du Promoteur",
    "projectInfo.promoterPlaceholder": "Entrez le nom du promoteur",
    "projectInfo.location": "Localisation",
    "projectInfo.locationPlaceholder": "Entrez la localisation",
    "projectInfo.sector": "Secteur d'Activité",
    "projectInfo.sectorPlaceholder": "Entrez le secteur",
    ...
    "products.name": "Nom",
    "products.namePlaceholder": "Entrez le nom du produit",
    "products.price": "Prix",
    ...
    "personnel.role": "Rôle",
    "personnel.rolePlaceholder": "Entrez le rôle",
    ...
    "activities.activityPlaceholder": "Entrez le nom de l'activité",
    ...
    "customers.segmentNamePlaceholder": "Entrez le nom du segment",
    ...
    "otherCharges.chargePlaceholder": "Entrez le nom de la charge",
    "otherCharges.rawMaterials": "Matières Premières",
    "otherCharges.addMaterial": "Ajouter un Matériau",
    "otherCharges.materialPlaceholder": "Entrez le nom du matériau",
